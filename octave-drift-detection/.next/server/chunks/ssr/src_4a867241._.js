...
async function fetchData() {
    try {
        ...
        const errors = {
            plotData: (rawData.id_error || []).map((item, index)=>({
                    x: index,
        ...
        if (!rawData.indices) {
            ...
            const driftIndices = [];
            (rawData.id_error || []).forEach((item, idx)=>{
...
//# sourceMappingURL=src_4a867241._.js.map