...
function Mode2Page() {
    ...
    const initData = async ()=>{
        ...
        try {
            const { kpis: fetchedKpis, errors: fetchedErrors, outletsExceedingThreshold: fetchedOutlets, state: fetchedState, coverage: fetchedCoverage, clusters: fetchedClusters, indices: fetchedIndices, backwardAnalysis: fetchedBackwardAnalysis, currentPeriod: fetchedCurrentPeriod, totalOutlets: fetchedTotalOutlets, outletsExceedingThresholdCount: fetchedOutletsExceedingThresholdCount, xaiExplanation: fetchedXai } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$backendService1$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchData"])();
            // Rebuild plotData using the top-level `indices` if present
            let plotData = [];
            if (fetchedIndices?.normal && fetchedIndices.warning && fetchedIndices.drift) {
                plotData = [
                    ...fetchedIndices.normal.map((idx)=>({
                            x: idx,
                            y: 0,
                            exceedsThreshold: false
                        })),
                    ...fetchedIndices.warning.map((idx)=>({
                            x: idx,
                            y: 1,
                            exceedsThreshold: false
                        })),
                    ...fetchedIndices.drift.map((idx)=>({
                            x: idx,
                            y: 2,
                            exceedsThreshold: false
                        }))
                ...
                // fallback to clustering by ID strings
                const warningSet = new Set(fetchedClusters.warning ?? []);
                const driftSet = new Set(fetchedClusters.drift ?? []);
                plotData = fetchedErrors.plotData.map((item, idx)=>({
                        x: idx,
                        y: warningSet.has(item.x.toString()) ? 1 : driftSet.has(item.x.toString()) ? 2 : 0,
                        exceedsThreshold: item.exceedsThreshold
                    }));
            }
            // commit everything into React state
            setKpis(fetchedKpis);
            setErrorData({
                plotData,
            ...
            if (err instanceof Error) {
                setBackendError(`Failed to load data: ${err.message}`);
            } else {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                    ...
                                                    children: errorData.tableData.slice(0, 5).map((err, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                            children: [
...
//# sourceMappingURL=src_671f22b9._.js.map