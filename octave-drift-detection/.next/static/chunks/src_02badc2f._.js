(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_02badc2f._.js", {
...
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chart$2e$js$2f$dist$2f$chart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Chart"].register(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chart$2e$js$2f$dist$2f$chart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["CategoryScale"], __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chart$2e$js$2f$dist$2f$chart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["LineController"], __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chart$2e$js$2f$dist$2f$chart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["PointElement"], __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chart$2e$js$2f$dist$2f$chart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["LineElement"], __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chart$2e$js$2f$dist$2f$chart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["LinearScale"], __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chart$2e$js$2f$dist$2f$chart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Tooltip"], __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chart$2e$js$2f$dist$2f$chart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Legend"]);
            ...
            const initData = {
                "Mode4Page.useEffect.initData": async ()=>{
                    try {
                        ...
                        const apiBase = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || 'http://127.0.0.1:5000';
                        console.log('Attempting to fetch from API base:', apiBase);
                        const [metricsRes, errorsRes] = await Promise.all([
                            fetch(`${apiBase}/api/metrics?mode=4`).catch({
                                "Mode4Page.useEffect.initData": (err)=>{
                                    console.error('Metrics fetch failed:', err);
                                    throw new Error(`Failed to reach metrics API: ${err.message}`);
                                }
                            }["Mode4Page.useEffect.initData"]),
                            fetch(`${apiBase}/api/errors`).catch({
                                "Mode4Page.useEffect.initData": (err)=>{
                        ...
                        const normalizedKpis = (metricsData.kpis || Object.entries(metricsData).map({
                            "Mode4Page.useEffect.initData.normalizedKpis": ([rowKey, value])=>({
                                    rowKey,
                                    value: String(value),
                                    status: metricsData.status
                                })
                        }["Mode4Page.useEffect.initData.normalizedKpis"])).filter({
                            "Mode4Page.useEffect.initData.normalizedKpis": (k)=>k.rowKey && k.value
                        }["Mode4Page.useEffect.initData.normalizedKpis"]);
                        // Normalize errors data format
                        const normalizedErrors = {
                            tableData: (errorsData.tableData || []).filter({
                                "Mode4Page.useEffect.initData": (e)=>e.predicted && e.actual
                            }["Mode4Page.useEffect.initData"]),
                        ...
                        const getKpiNumberValue = {
                            "Mode4Page.useEffect.initData.getKpiNumberValue": (key)=>{
                                const kpi = normalizedKpis.find({
                                    "Mode4Page.useEffect.initData.getKpiNumberValue.kpi": (k)=>k.rowKey === key
                                }["Mode4Page.useEffect.initData.getKpiNumberValue.kpi"]);
                                if (!kpi) return 0;
                                const num = Number(kpi.value);
                                return isNaN(num) ? 0 : num;
                            }
                        }["Mode4Page.useEffect.initData.getKpiNumberValue"];
                        setConfusionMatrix({
                            reference: {
                                matrix: [
                                    [
                                                    ...
                                                    chartRef.current = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chart$2e$js$2f$dist$2f$chart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Chart"](ctx, {
                                                        ...
                                                        data: {
                                                            ...
                                                            datasets: [
                                                                {
                                                                    label: 'Drift Level',
                                                                    data: errors.plotData?.length ? errors.plotData.map((point)=>Math.floor(point.y) % 3) : kpis.filter((k)=>k.rowKey.includes('currentDrift')).map((k)=>Math.floor(parseFloat(k.value)) % 3),
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: loading ? '-' : confusionMatrix.current?.precision?.toFixed(2) || 'N/A'
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/mode4/page.tsx",
                                                    lineNumber: 432,
                                                    columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-lg font-semibold text-white",
                                                    children: loading ? '-' : confusionMatrix.current?.recall?.toFixed(2) || 'N/A'
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/mode4/page.tsx",
                                                    lineNumber: 438,
                                                    columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-lg font-semibold text-white",
                                                    children: loading ? '-' : confusionMatrix.current?.f1?.toFixed(2) || 'N/A'
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/mode4/page.tsx",
                                                    lineNumber: 444,
                                                    columnNumber: 17
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-xl",
                                                children: loading ? 'Loading...' : kpis.find((k)=>k.rowKey === 'hyperparameters')?.value || 'N/A'
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/mode4/page.tsx",
                                                lineNumber: 457,
                                                columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "bg-yellow-900/20 p-4 rounded-lg border border-yellow-800/50",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
...
_s(Mode4Page, "3IYO7DP7zmUy5mFdBC5PsuvA0mI=");
_c = Mode4Page;
var _c;
...
//# sourceMappingURL=src_02badc2f._.js.map