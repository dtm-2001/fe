(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_0586d1f8._.js", {
...
function Mode2Page() {
    ...
    const [businessUnits] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        'CCS',
        'JMSL'
    ]);
    const [useCases] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        'CCS': [
            'CC-Di',
            'CC-MT'
        ],
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Mode2Page.useEffect": ()=>{
            const initData = {
                "Mode2Page.useEffect.initData": async ()=>{
                    try {
                        const [kpiData, errorData, xaiResponse] = await Promise.all([
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$backendService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchMode2KPIs"])(),
                            ...
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$backendService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchMode2XAIData"])()
                        ]);
                        setKpis(kpiData);
                        setErrors({
                        ...
                        const sampleErrors = Array.from({
                            ...
                            "Mode2Page.useEffect.initData.sampleErrors": (_, i)=>({
                                    id: `ERR-SAMPLE-${i + 1}`,
                        ...
                        }["Mode2Page.useEffect.initData.sampleErrors"]);
                        setKpis([
                            {
                                rowKey: 'alertTime',
                        ...
                        setErrors({
                            plotData: sampleErrors.map({
                                "Mode2Page.useEffect.initData": (err)=>({
                                        x: err.timePeriod,
                                        y: err.error,
                                        exceedsThreshold: err.exceedsThreshold
                                    })
                            }["Mode2Page.useEffect.initData"]),
                            tableData: sampleErrors.map({
                                "Mode2Page.useEffect.initData": (err)=>({
                                        id: err.id,
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                    ...
                                                    children: errors.tableData.filter((e)=>e.status === 'Alert').slice(0, 5).map((error, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                    className: "px-6 py-4 whitespace-nowrap text-sm text-white",
                                                                    children: error.id
...
_s(Mode2Page, "Ba7TO3VviuE/kTYc3iSIRgozQGQ=");
_c = Mode2Page;
var _c;
...
//# sourceMappingURL=src_0586d1f8._.js.map