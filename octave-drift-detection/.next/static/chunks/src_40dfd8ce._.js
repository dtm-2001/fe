(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_40dfd8ce._.js", {
...
const D3ConfusionMatrix = ({ data, labels, title, width, height })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "D3ConfusionMatrix.useEffect": ()=>{
            ...
            const matrixData = data.flatMap({
                "D3ConfusionMatrix.useEffect.matrixData": (row, y)=>row.map({
                        "D3ConfusionMatrix.useEffect.matrixData": (v, x)=>({
                                x,
                                y,
                                v
                            })
                    }["D3ConfusionMatrix.useEffect.matrixData"])
            }["D3ConfusionMatrix.useEffect.matrixData"]);
            const maxVal = Math.max(...matrixData.map({
                "D3ConfusionMatrix.useEffect.maxVal": (d)=>d.v
            }["D3ConfusionMatrix.useEffect.maxVal"]));
            const chart = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chart$2e$js$2f$dist$2f$chart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Chart"](ctx, {
                type: 'matrix',
                data: {
                    datasets: [
                        {
                            ...
                            data: matrixData,
                            backgroundColor: {
                                "D3ConfusionMatrix.useEffect": (ctx)=>{
                            ...
                            width: {
                                "D3ConfusionMatrix.useEffect": ({ chart })=>{
                ...
                options: {
                    ...
                    plugins: {
                        tooltip: {
                            callbacks: {
                                title: {
                                    "D3ConfusionMatrix.useEffect": ()=>title
                                }["D3ConfusionMatrix.useEffect"],
                                label: {
                                    "D3ConfusionMatrix.useEffect": (ctx)=>{
...
_s(D3ConfusionMatrix, "UJgi7ynoup7eqypjnwyX/s32POg=");
...
function Mode3Page() {
    ...
    const [confusionGrid, setConfusionGrid] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
        ...
        "Mode3Page.useEffect": ()=>{
            async function init() {
                ...
                try {
                    ...
                    const xs = fetchedErrors.plotData.map({
                        "Mode3Page.useEffect.init.xs": (p)=>p.x
                    }["Mode3Page.useEffect.init.xs"]);
                    const ys = fetchedErrors.plotData.map({
                        "Mode3Page.useEffect.init.ys": (p)=>p.y
                    }["Mode3Page.useEffect.init.ys"]);
                    const maxX = xs.length ? Math.max(...xs) : 0;
                    const maxY = ys.length ? Math.max(...ys) : 0;
                    const grid = Array.from({
                        length: maxY + 1
                    }, {
                        "Mode3Page.useEffect.init.grid": ()=>Array(maxX + 1).fill(0)
                    }["Mode3Page.useEffect.init.grid"]);
                    fetchedErrors.plotData.forEach({
                        "Mode3Page.useEffect.init": (pt)=>{
                            grid[pt.y][pt.x] = pt.value ?? 0;
                        }
                    }["Mode3Page.useEffect.init"]);
                    setConfusionGrid(grid);
                    setLabels(Array.from({
                        length: maxX + 1
                    }, {
                        "Mode3Page.useEffect.init": (_, i)=>i.toString()
                    }["Mode3Page.useEffect.init"]));
                } catch (err) {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                    ...
                                                    children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        ...
                                                        lineNumber: 401,
                                                        columnNumber: 21
                                                    }, this) : outletsExceedingThreshold.length > 0 ? outletsExceedingThreshold.map((o)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                    className: "px-6 py-4 whitespace-nowrap text-sm text-white",
                                                                    children: o.id
...
_s(Mode3Page, "1BNkyRQHFhhIprIkgvmXwnkMbsM=");
_c = Mode3Page;
var _c;
...
//# sourceMappingURL=src_40dfd8ce._.js.map