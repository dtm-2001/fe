                    ...
                    plugins: {
                        legend: {
                            ...
                            labels: {
                                ...
                                generateLabels: {
                                    "Mode4Page.useEffect": (chart)=>chart.data.labels.map({
                                            "Mode4Page.useEffect": (label, i)=>({
                        ...
                        tooltip: {
                            callbacks: {
                                label: {
                                    "Mode4Page.useEffect": (ctx)=>`${ctx.label}: ${ctx.raw}%`
                                }["Mode4Page.useEffect"]
                            }
                        }
                    }
...
_s(Mode4Page, "rVYpzMadx2pBsrsExMNjr1O9fy4=");
_c = Mode4Page;
var _c;
